...
public class CashServiceImpl implements CashService {
	...
	@Override
	@Transactional(readOnly = true)
	public Page<CashTransferHistoryResponse> getCashTransferHistory(String userUuid, CashTransferStatus status, LocalDate month, Pageable pageable) {
		...
		return cashTransferRepository.findByUserUuidAndStatusAndDateRange(userUuid, status, startOfMonth, endOfMonth, pageable)
